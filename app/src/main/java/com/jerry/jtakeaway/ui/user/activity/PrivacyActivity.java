...
public class PrivacyActivity extends BaseActivity {
    ...
    public void InitData() {
        String html = "<p><strong>版本生效日期：2020-06-27</strong></p>" +
                "                \"<p> 疯狂外卖（以及下文提到的“我们”、“我们的”或“本app”）是由主体公司提供的网络产品。" +
                "                \"    </br>产品名称： jtakeaway    </br>产品类别：app        </br>如果您决定使用我们产品提供的服务，本协议用于告知我们对于用户的隐私如何收集、使用和披露。" +
                "                \"    </br></p><p><strong>如果您选择使用我们提供的服务，则表示您同意收集和使用与此政策相关的信息。我们收集的个人信息用于提供和改进服务。除非本隐私政策中另有说明，否则我们不会与任何人一起使用或分享您的信息。</strong></p>" +
                "                \"<p>除非本隐私政策另有规定，否则本隐私政策中使用的术语与我们的条款和条件具有相同的含义，可在jtakeaway中访问。</p>" +
                ...
                "                \"<p> jtakeaway将收集的数据用于以下其中的部分或全部目的：</p>" +
                "                \"<li>提供和维护服务</li>" +
                "                \"<li>通知您有关我们服务的更改</li>" +
                ...
                "                \"" +
                "                \"    <p>我们会定期推送相关信息，如果您想退订，请依照如下方式操作：</p>" +
                "                \"            <li>点击推送邮件中的“退订链接”进行退订；</li>" +
                "                \"        " +
                ...
                "                \"<p> jtakeaway可能会真诚地披露您的个人资料，相信此类行为是必要的：" +
                "                \"<li>履行法律义务</li>" +
                ...
                "                \"    </br>通过邮件：    </br>通过链接：http://www.fkwm.cn    </br>通过电话：</p>" +
