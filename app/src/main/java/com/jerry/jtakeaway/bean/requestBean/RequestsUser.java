...
public class RequestsUser<T> {
    ...
    public RequestsUser(int id, String account, String password, String usernickname, String useradvatar, int usertype, T userdetails, String phone, String email) {
        this.id = id;
