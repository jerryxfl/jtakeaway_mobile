...
//    public static final String host = "http://121.199.9.234:8080/api-0.1/";
    ...
    public static final String create_order(int suserid, int menuid, int size, int addressid) {
        return host + "N/order?sId=" + suserid + "&mId=" + menuid + "&mSize=" + size + "&addressId=" + addressid;
    }
    ...
    public static final String five_level_shop(int size) {
        return host + "G/five_level_shop?size=" + size;
    }

    public static final String red_people_shop(int size) {
        return host + "G/red_people_shop?size=" + size;
    }

    public static final String msg_red(int MSGID) {
        return host + "U/msg_red?msgid=" + MSGID;
    }

    public static final String orders(int size) {
        return host + "N/orders?size=" + size;
    }

    public static final String shop_comment(int suserid) {
    ...
    public static final String Sign = host + "authen/Sign";
}